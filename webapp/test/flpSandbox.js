		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CARTON ENQUIRY",
									"targetURL": "#idcartonenquiryzcartonenquiry-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idcartonenquiryzcartonenquiry-display": {
								"semanticObject": "idcartonenquiryzcartonenquiry",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idcartonenquiry.zcartonenquiry",
									"url": sap.ui.require.toUrl("idcartonenquiry/zcartonenquiry")
								}
							}
						}
					}
